...
procedure DrawRectangleRounded(aRec : TRectangle; aRoundness : Single; aSegments, aLineThick : Integer; aColor : TColor) cdecl; external cDllName;
procedure DrawRectangleRoundedLines(aRec : TRectangle; aRoundness : Single; aSegments, aLineThick : Integer; aColor : TColor) cdecl; external cDllName;
